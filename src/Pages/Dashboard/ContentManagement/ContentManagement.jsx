            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-1 font-medium">Dashboard / Blogs</p>
                    </div>
                ...
                <div className="overflow-x-auto bg-white rounded-[2rem] shadow-sm border border-slate-100">
                    <table className="table w-full border-separate border-spacing-0">
                        <thead className="bg-slate-50/50">
                            <tr className="text-slate-500 uppercase text-[12px] tracking-widest font-bold">
                            ...
                            {blogs.length > 0 ? (
                                blogs.map((blog) => (
                                    <tr key={blog._id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td>
                                            <span className={`px-4 py-1.5 rounded-full text-[11px] font-semibold uppercase tracking-wider ${
