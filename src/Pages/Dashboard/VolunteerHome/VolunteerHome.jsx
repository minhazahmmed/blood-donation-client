  ...
  const cards = [
    {
      ...
      icon: <ClipboardDocumentListIcon className="h-8 w-8 text-blue-700" />,
      bg: "bg-blue-50",
    ...
    },
    {
      ...
      icon: <ClockIcon className="h-8 w-8 text-yellow-700" />,
      bg: "bg-yellow-50",
    ...
    },
    {
      id: 4,
      name: "My Draft Blogs",
      value: stats?.myDraftBlogs,
      icon: <DocumentPlusIcon className="h-8 w-8 text-purple-700" />,
      bg: "bg-purple-50",
      ...
      <div className="mb-8 bg-white p-6 sm:p-10 rounded-[2rem] shadow-sm border border-red-50 relative overflow-hidden">
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl font-semibold text-slate-800 tracking-tight">
            ...
            <PiHandWaving className="text-yellow-800" />
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
          {cards.map((card) => (
            <div
              key={card.id}
              className={`${card.bg} ${card.border} p-8 rounded-[2rem] border shadow-sm hover:shadow-md transition-all group`}
            >
